...
@Component({
  selector: 'app-nurse-solicitud-medicina',
  templateUrl: './nurse-solicitud-medicina.component.html',
  styleUrls: ['./nurse-solicitud-medicina.component.css']
})
export class NurseSolicitudMedicinaComponent implements OnInit {
 ...
 ngOnInit(): void { 
  ...
  medicinaCamino(idMedicineOne: Number, idMedicineTwo:Number, idMedicineThree:Number, idBodega:Number, idOrden:Number){
    ...
    this.router.navigate(['nurseSolicitudesMedicinas2']);
  }
