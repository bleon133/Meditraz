...
@Component({
  selector: 'app-tecnico-despacho-medicina-cambio',
  templateUrl: './tecnico-despacho-medicina-cambio.component.html',
  styleUrls: ['./tecnico-despacho-medicina-cambio.component.css']
})
export class TecnicoDespachoMedicinaCambioComponent implements OnInit {
  ...
  cantidades1(){
    ...
    return (this.dataSourceOrdenes.find(x=>x.orderNumber === this.dataSourcePedidos[0].idOrder)?.amountRequired);
  }

  cantidades2(){
    return (this.dataSourceOrdenes.find(x=>x.orderNumber === this.dataSourcePedidos[0].idOrder)?.amountRequiredTwo);
  }

  cantidades3(){
    return (this.dataSourceOrdenes.find(x=>x.orderNumber === this.dataSourcePedidos[0].idOrder)?.amountRequiredThree);
  }
