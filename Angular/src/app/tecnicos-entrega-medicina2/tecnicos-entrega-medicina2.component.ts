...
@Component({
  selector: 'app-tecnicos-entrega-medicina2',
  templateUrl: './tecnicos-entrega-medicina2.component.html',
  styleUrls: ['./tecnicos-entrega-medicina2.component.css']
})
export class TecnicosEntregaMedicina2Component implements OnInit {
