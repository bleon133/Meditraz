...
@Component({
  selector: 'app-tecnicos-gestion-medicamentos',
  templateUrl: './tecnicos-gestion-medicamentos.component.html',
  styleUrls: ['./tecnicos-gestion-medicamentos.component.css']
})
export class TecnicosGestionMedicamentosComponent implements OnInit {
 ...
 ngOnInit(): void { 
  ...
  medicinaCamino(idMedicineOne: Number, idMedicineTwo:Number, idMedicineThree:Number, idBodega:Number, idOrden:Number){
    ...
    this.router.navigate(['tecnicoGestionMedicamento2']);
  }
