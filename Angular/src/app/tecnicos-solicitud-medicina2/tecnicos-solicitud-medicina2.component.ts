...
@Component({
  selector: 'app-tecnicos-solicitud-medicina2',
  templateUrl: './tecnicos-solicitud-medicina2.component.html',
  styleUrls: ['./tecnicos-solicitud-medicina2.component.css']
})
export class TecnicosSolicitudMedicina2Component implements OnInit {
